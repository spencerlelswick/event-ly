    ...
    >
      <Popup autoPan={false}>
        ...
        <div className="flex flex-col  gap-1 mb-1 mx-1 min-h-60 max-w-[200px] " >
          ...
          <div class="avatar">
            <div class="mb-1 rounded-btn w-56 h-24">
              <img src={event.image} />
            </div>
          </div>
          ...
          <h2 className="card-title">
            ...
            {dateDisplay(event.date) === dateDisplay(new Date()) ?
              <div className="badge badge-secondary" >TODAY </div> : null}
            </div>
        ...
        <div className="card-actions justify-end mt-2">
          <div className="badge badge-outline">Guests: {event.guests.length}</div>
